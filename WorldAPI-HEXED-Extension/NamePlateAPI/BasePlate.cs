...
public static class BasePlate {
    public static Plate AddPlate(this Player player) => new Plate(player);
    ...
    public class Plate {
        ...
        public Plate(Player player) {
            ...
            if (PlateCount == 0) {
                transform.parent.Find("Main/Group Banner").localScale = new Vector3(0f, 0f, 0f);
                transform.parent.Find("Main/Group Banner_Expanded").localScale = new Vector3(0f, 0f, 0f);
                transform.parent.Find("Group Info").localScale = new Vector3(0f, 0f, 0f);
            }
        ...
        public Tag AddTag(string text) => new Tag(this, text);
        public Icon AddIcon(Sprite sprite, Sprite subSprite = null) => new Icon(this, sprite, subSprite);
        ...
        public class Tag {
            ...
            public Tag(Plate plate, string text) {
                ...
                TMProCompt.color = new Color(1f, 1f, 1f, 1f);
            }
        }
        #endregion
